...
create_page_by_type("sequential", path, include_example=False)
create_page_by_type("diverging", path, include_example=False)
create_page_by_type("qualitative", path, include_example=False)
